...
| 50 ~ 70 | 适中 | 历史常态区间，贵金属市场相对均衡 |
| 70 ~ 85 | 偏高 | 白银相对黄金偏弱，市场避险需求较强 |
| 85 ~ 100 | 极高 | 白银被严重低估，避险情绪极端 |
...
进入 **Actions** 标签页 → 选择 **贵金属日报** → 点击 **Run workflow**

### 4. 验证推送

检查飞书是否收到贵金属日报卡片消息。如果未收到，请参考下方 [常见问题](#常见问题) 排查。
